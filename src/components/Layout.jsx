...
import { BookOpen, FlaskConical, GitCompareArrows, Home, LogIn, Network, PlusCircle, Users } from 'lucide-react';
    ...
    <div className="app-shell">
      <header className="site-header">
        <Link to="/" className="brand">
          <span className="brand-mark">RSE</span>
          <span><strong>Ready...Set...Evidence</strong><small>Evidence Commons</small></span>
        </Link>
      ...
      <footer className="site-footer">
        <span>Ready...Set...Evidence</span>
        <span>Every conclusion traceable to its evidence.</span>
      </footer>
    </div>
  );
}
